...
public class DefinitionSteps {
	...
	public void user_lands_on_page_X(String gherkinPageName, String gherkinObjectType) throws Throwable {
		if(gherkinObjectType.equalsIgnoreCase("section"))
			user.lands_on_the_section_X(gherkinPageName);
		else if (gherkinObjectType.equalsIgnoreCase("sub-section"))
			user.lands_on_the_sub_section_X(gherkinPageName);
		else 
	...
	public void user_clicks_on_element_X(String gherkinElement,String gherkinObjectType ) throws Throwable {
		if(gherkinObjectType.equalsIgnoreCase("section link"))
			user.clicks_on_the_section_link_X(gherkinElement);
		else
		    user.clicks_on_element_X(gherkinElement);
	}
